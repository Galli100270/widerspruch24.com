...
import { Copy, Zap, CheckCircle2, AlertCircle, Loader2, ChevronRight, Clock, ExternalLink } from 'lucide-react';
...
// Paywall-Hinweis für bestimmte Bot-Antworten
const PaywallHint = ({ message }) => {
    // Prüfe, ob die Nachricht auf bezahlte Features hindeutet
    const containsPaywallKeywords = message.includes('Scanner') || 
                                   message.includes('Generator') || 
                                   message.includes('vollständige') ||
                                   message.includes('professionell') ||
                                   message.includes('Website');
    
    if (!containsPaywallKeywords) return null;
            ...
            <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                    <p className="text-sm font-medium text-blue-900 mb-1">
                        💡 Tipp von Paragraphen-Heini
                    </p>
                    <p className="text-xs text-blue-700 mb-2">
                        Für vollständige Widersprüche und professionelle Analyse nutzen Sie unsere Hauptfunktionen:
                    </p>
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                ...
                {/* Paywall-Hinweis für Bot-Antworten */}
                {!isUser && message.content && (
                    <PaywallHint message={message.content} />
                )}
